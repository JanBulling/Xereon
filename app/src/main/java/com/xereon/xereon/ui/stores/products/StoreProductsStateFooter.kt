...
import com.xereon.xereon.databinding.StoreProductsStateAdapterBinding

class StoreProductsStateFooter(private val retry: () -> Unit) :
    LoadStateAdapter<StoreProductsStateFooter.VH>() {

    override fun onCreateViewHolder(parent: ViewGroup, loadState: LoadState): VH {
        val binding = StoreProductsStateAdapterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    inner class VH(private val binding: StoreProductsStateAdapterBinding) :
