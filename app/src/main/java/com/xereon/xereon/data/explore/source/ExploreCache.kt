...
import com.xereon.xereon.data.explore.ExploreCache
import java.io.File
...
class ExploreCache @Inject constructor(
    ...
    fun load(): ByteArray? = try {
        ...
        Log.e(TAG, e.message + " Failed to load raw statistics from cache.")
        null
    }
