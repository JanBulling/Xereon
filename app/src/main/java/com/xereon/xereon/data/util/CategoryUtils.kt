...
object CategoryUtils {
    ...
    private val mCategories = arrayOf(
        Category(9, "Bauen & Wohnen", R.color.type_red, -1, -1,
        ...
        Category(2, "Dienstleistungen", R.color.type_azure, R.drawable.ic_barber, -1,
            "Alles vom Frisör bis zur Nagelmaniküre!",
            arrayOf("Frisör", "Taxi", "ÖPNV", "Reisebüro", "Fahrschule", "Bank", "Post", "Haushaltshilfe", "Versicherung", "Behörde", "Waschanlage")
        ),
        ...
        Category(12, "Handwerk", R.color.type_red, -1, -1,
        ...
        Category(7, "Hotel", R.color.type_yellow, -1, -1,
        ...
        Category(10, "Medien und Spielwaren", R.color.type_red, -1, -1,
        ...
        Category(8, "Medizinbedarf", R.color.type_rose, -1, -1, "Aua! Was war das? Leiber schnell zu einem Arzt oder einer nahegelegenen Apotheke!",
            arrayOf("Apotheke", "Optiker", "Arzt")
        ),
        Category(1, "Mode / Kleidung", R.color.type_red, -1, -1,
        ...
        Category(3, "Restaurant", R.color.type_orange, R.drawable.ic_restaurant, -1,
            ...
            arrayOf("Imbiss", "FastFood", "Pizzaria", "Traditionel", "Biergarten", "Chinesisch", "Grichisch", "Italienisch", "Mexikanisch", "Thailändisch"
            )
        ),
        Category(11, "Sportbedarf", R.color.type_red, -1, -1,
        ...
        Category(6, "Unterhaltung", R.color.type_violet, -1, -1,
